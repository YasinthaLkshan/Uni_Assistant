...
const DashboardPage = () => {
  ...
  if (showLoadingShell) {
    return (
      <section className={`dashboard dashboard-page loading-shell ${loading ? "is-entering" : "is-leaving"}`.trim()}>
      ...
      <GlassCard as="section" className="ui-section section-entrance dashboard-tasks" style={{ animationDelay: "260ms" }}>
        ...
        {summary.todaysTasks.length ? (
          ...
          <EmptyStateCard
            ...
            description="Great progress. You are currently clear for today."
          />
        )}
      </GlassCard>
    </section>
